...
CREATE TABLE `products` (
    ...
    `price` DOUBLE NOT NULL,
<<<<<<<< HEAD:api/prisma/migrations/20240906133256_initial_migration/migration.sql
========
    `imageUrl` VARCHAR(191) NULL,
    `stock` INTEGER NOT NULL DEFAULT 0,
>>>>>>>> bc2c13e5 (firist draft push):api/prisma/migrations/20241026135006_init/migration.sql
